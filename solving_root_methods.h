...
void false_position(int EQ_i, double x_l, double x_u, int iters, double percent);

void secant(int EQ_i, double x_i_0, double x_i_1, int iters, double percent);

void newton_raphson(int EQ_i, double x_i_1, int iters, double percent);
...
void false_position(int EQ_i, double x_l, double x_u, int iters, double percent) {
    ...
    switch (EQ_i) {
        case 1:
            //f(x) = X^3 - 8X^2 + 12X - 4
            while ((i < iters and percent == 100.0) or (root_error > percent and iters == -1)) {
